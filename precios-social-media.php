...
$mail = $_GET['mail'];
if(!isset($mail)){
  header("Location: certificado-digital.html");
}
...
<head>
  <meta charset="utf-8">
  <title>Precios Social Media - Softdirex</title>
  <script>
          ...
          <ul>
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a href="social-media.html">Social media</a></li>
                ...
                <div class="col-md-4">
                  <div class="pricing hover-effect">
                    <div class="pricing-head">
                      <h3>Basico
                      <span>
                         Anual $326.280+iva <strong>(Ahorro 15%)</strong>
                      </span>
                      </h3>
                      <h4><i>$</i>31.990<i>+iva</i>
                      <span>
                         Mensual
                      </span>
                      </h4>
                    ...
                    <ul class="pricing-content list-unstyled">
                      <li>
                        <i class="fa fa-comments-o"></i> Un blog en su sitio web.
                      </li>
                      <li>
                        <i class="fa fa-asterisk"></i> 2 Publicaciones mensuales.
                      </li>
                      <li>
                        <i class="fa fa-facebook-square"></i> Sitio web en Facebook.
                      </li>
                      <li>
                        <i class="fa fa-users"></i> 2 Redes sociales a elección.
                      </li>
                      <li>
                        <i class="fa fa-photo"></i> Hasta 2 Diseños de imágenes en el mes.
                      </li>
                      <li>
                        <i class="fa fa-play-circle"></i> Presentaciones adicionales <strong>$15.900+iva C/U</strong>.
                      </li>
                      <li>
                        <i class="fa fa-video-camera"></i> Videos* adicionales <strong>31.990+iva C/U</strong>.
                      </li>
                    </ul>
                ...
                <div class="col-md-4">
                  <div class="pricing pricing-active hover-effect">
                    <div class="pricing-head pricing-head-active">
                      <h3>Medio
                      <span>
                         Anual $745.990+iva <strong>(Ahorro 20%)</strong>
                      </span>
                      </h3>
                      <h4><i>$</i>67.290<i>+iva</i>
                      <span>
                         Mensual
                      </span>
                      </h4>
                    ...
                    <ul class="pricing-content list-unstyled">
                      ...
                      <li>
                        <i class="fa fa-asterisk"></i> 4 Publicaciones mensuales.
                      </li>
                      <li>
                        <i class="fa fa-linkedin"></i> Página empresarial en Linkedin
                      </li>
                      <li>
                        <i class="fa fa-facebook-square"></i> Sitio web en Facebook.
                      </li>
                      <li>
                        <i class="fa fa-users"></i> Redes sociales a elección sin límite.
                      </li>
                      <li>
                        <i class="fa fa-photo"></i> Hasta 4 Diseños de imágenes en el mes.
                      </li>
                      <li>
                        <i class="fa fa-video-camera"></i> 1 Video* en el mes previa solicitud.
                      </li>
                      <li>
                        <i class="fa fa-facebook"></i> 1 Campaña publicitaria en Facebook (Con costos adicionales)
                      </li>
                      <li>
                        <i class="fa fa-play-circle"></i> Hasta 2 Presentaciones en el mes.
                      </li>
                      <li>
                        <i class="fa fa-play-circle"></i> Presentaciones adicionales <strong>$15.900+iva C/U</strong>.
                      </li>
                ...
                <div class="col-md-4">
                  <div class="pricing hover-effect">
                    <div class="pricing-head">
                      <h3>Avanzado
                      <span>
                         Anual $943.200+iva <strong>(Ahorro 30%)</strong>
                      </span>
                      </h3>
                      <h4><i>$</i>112.290<i>+iva</i>
                      <span>
                         Mensual
                      </span>
                      </h4>
                    ...
                    <ul class="pricing-content list-unstyled">
                      ...
                      <li>
                        <i class="fa fa-user-plus"></i> Sistema de registro de clientes.
                      </li>
                      <li>
                        <i class="fa fa-asterisk"></i> 8x Publicaciones mensuales.
                      </li>
                      <li>
                        <i class="fa fa-linkedin"></i> Página empresarial en Linkedin
                      </li>
                      ...
                      <li>
                        <i class="fa fa-photo"></i> Hasta 8 Diseños de imágenes en el mes.
                      </li>
                      <li>
                        <i class="fa fa-video-camera"></i> 2 Videos* en el mes previa solicitud.
                      </li>
                      <li>
                        <i class="fa fa-facebook"></i> Campañas publicitaria en Facebook (Con costos adicionales)
                      </li>
                      <li>
                        <i class="fa fa-google"></i> Campañas publicitaria en Google (Con costos adicionales)
                      </li>
                      <li>
                        <i class="fa fa-play-circle"></i> Hasta 4 Presentaciones en el mes.
                      </li>
                      <li>
                        <i class="fa fa-play-circle"></i> Presentaciones adicionales <strong>$15.900+iva C/U</strong>.
                      </li>
