...
<head>
  <meta charset="utf-8">
  <title>Mis Datos - Softdirex</title>
  <script>
                  ...
                  <div class="header-navigation-content">
                    <div class="row">
                      <div class="col-md-4 header-navigation-col">
                        <h4>Perfil</h4>
                        <ul>
                          <li class="active"><a href="misdatos.php">Datos personales</a></li>
                        </ul>
                      </div>
                      <div class="col-md-4 header-navigation-col">
                        <h4>Proyectos</h4>
        ...
        <div class="row margin-bottom-40">
          ...
          <div class="sidebar col-md-3 col-sm-3">
            <ul class="list-group margin-bottom-25 sidebar-menu">
              <li class="list-group-item clearfix"><a href="misdatos.php"><i class="fa fa-angle-right"></i> Actualiza tus datos</a></li>
              <li class="list-group-item clearfix"><a href="proyectos.php"><i class="fa fa-angle-right"></i> Revisa tus proyectos</a></li>
              <li class="list-group-item clearfix"><a href="cuenta.php"><i class="fa fa-angle-right"></i> Realiza pagos online</a></li>
            </ul>
          </div>
          <!-- END SIDEBAR -->
            ...
            <div class="content-form-page">
              <div class="row">
                <div class="col-md-7 col-sm-7">
                  <form action="int/fn/modificarDatos.php" class="form-horizontal" role="form" method="post">
                    <fieldset>
                      <legend>Datos personales</legend>
                      <div class="form-group">
                        <label for="rut" class="col-lg-4 control-label">Rut <span class="require">*</span></label>
                        <div class="col-lg-8">
                          <input type="text" class="form-control" id="rut" name="rut" value="<?php echo $usuario1->getRut() ?>"  minlength="10" maxlength="10" readonly="">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="nombre" class="col-lg-4 control-label">Nombre <span class="require">*</span></label>
                        <div class="col-lg-8">
                          <input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo $usuario1->getNombre() ?>" minlength="3" maxlength="60" required="">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="telefono" class="col-lg-4 control-label">Teléfono</label>
                        <div class="col-lg-8">
                          <input type="text" class="form-control" id="telefono" value="<?php echo $usuario1->getTelefono() ?>" name="telefono" minlength="8" maxlength="12">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="direccion" class="col-lg-4 control-label">Dirección</label>
                        <div class="col-lg-8">
                          <input type="text" class="form-control" id="direccion" name="direccion" value="<?php echo $usuario1->getDireccion() ?>" minlength="8" maxlength="60">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="comuna" class="col-lg-4 control-label">Comuna</label>
                        <div class="col-lg-8">
                          <input type="text" class="form-control" id="comuna" name="comuna" value="<?php echo $usuario1->getComuna() ?>" maxlength="60">
                        </div>
                      </div>
                    </fieldset>
                    <div class="row">
                      <div class="col-lg-8 col-md-offset-4 padding-left-0 padding-top-20">                        
                        <button type="submit" class="btn btn-primary">Actualizar</button>&nbsp;&nbsp;&nbsp;<a href="javascript:history.back(-1)" class="btn btn-default">Cancelar</a>
                      </div>
                    </div>
                  </form>
                  <form action="int/fn/cambiarMail.php" class="form-horizontal" role="form" method="post">
                    <fieldset>
                      <legend>Tu Correo electronico</legend>
                      <div class="form-group">
                        <label for="correo" class="col-lg-4 control-label">Correo actual <span class="require">*</span></label>
                        <div class="col-lg-8">
                          <input type="email" class="form-control" id="correo" name="correo" minlength="4" maxlength="25" required="" value="<?php echo $usuario1->getMail() ?>">
                          <input type="hidden" class="form-control" id="rut2" name="rut2" value="<?php echo $usuario1->getRut() ?>"  minlength="10" maxlength="10" readonly="">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="mail1" class="col-lg-4 control-label">Nuevo correo <span class="require">*</span></label>
                        <div class="col-lg-8">
                          <input type="email" class="form-control" id="mail1" name="mail1" minlength="4" maxlength="25" required="">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="mail2" class="col-lg-4 control-label">Repita correo <span class="require">*</span></label>
                        <div class="col-lg-8">
                          <input type="email" class="form-control" id="mail2" name="mail2" minlength="4" maxlength="25" required="">
                        </div>
                      </div>
                    </fieldset>
                    <div class="row">
                  ...
                  <form action="int/fn/cambiarPass.php" class="form-horizontal" role="form" method="post">
                    <fieldset>
                      <legend>Tu Contraseña</legend>
                      <div class="form-group">
                        <label for="actual" class="col-lg-4 control-label">Contraseña actual <span class="require">*</span></label>
                        <div class="col-lg-8">
                          <input type="password" class="form-control" id="actual" name="actual" minlength="4" maxlength="25" required=""><input type="hidden" class="form-control" id="rut3" name="rut3" value="<?php echo $usuario1->getRut() ?>"  minlength="10" maxlength="10" readonly="">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="pass1" class="col-lg-4 control-label">Nueva contraseña <span class="require">*</span></label>
                        <div class="col-lg-8">
                          <input type="password" class="form-control" id="pass1" name="pass1" minlength="4" maxlength="25" required="">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="pass2" class="col-lg-4 control-label">Repita contraseña <span class="require">*</span></label>
                        <div class="col-lg-8">
                          <input type="password" class="form-control" id="pass2" name="pass2" minlength="4" maxlength="25" required="">
                        </div>
                      </div>
                    </fieldset>
                    <div class="row">
