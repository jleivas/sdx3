...
?>
<script>
alert('Lo sentimos. Has sido bloqueado de los registros.');
...
<head>
  <meta charset="utf-8">
  <title>Certificado Digital - Softdirex</title>
  <script>
          ...
          <ul>
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a href="certificado-digital.html">Certificado digital</a></li>
        ...
        <div class="row margin-bottom-40">
          ...
          <div class="sidebar col-md-3 col-sm-3">
            <ul class="list-group margin-bottom-25 sidebar-menu">
              <li class="list-group-item clearfix"><a href="http://www.sii.cl/factura_electronica/certificado_digital.htm" target="_blank"><i class="fa fa-angle-right"></i> Certificado digital</a></li>
              <li class="list-group-item clearfix"><a href="http://www.sii.cl/factura_electronica/mn_Prov_CD.htm" target="_blank"><i class="fa fa-angle-right"></i> Empresas proveedoras</a></li>
              <li class="list-group-item clearfix"><a href="http://www.sii.cl/destacados/factura_electronica/inscp_factura_sii.htm" target="_blank"><i class="fa fa-angle-right"></i> Inscripción</a></li>
              <li class="list-group-item clearfix"><a href="https://www1.sii.cl/cvc_cgi/dte/pf2_inscripcion?MIPYME" target="_blank"><i class="fa fa-angle-right"></i> Verificar factibilidad</a></li>
              <li class="list-group-item clearfix"><a href="http://www.sii.cl/destacados/factura_electronica/configurar_computador.htm" target="_blank"><i class="fa fa-angle-right"></i> Requisitos del computador</a></li>
            </ul>
          </div>
          <!-- END SIDEBAR -->
          ...
          <div class="col-md-9 col-sm-9">
            <h1>Solicitar certificado digital</h1>
            <div class="content-form-page">
              <div class="row">
                <div class="col-md-7 col-sm-7">
                  <form class="form-horizontal" role="form" method="post" action="cert-dig.php">
                    <fieldset>
                      <legend>Datos personales</legend>
                      <div class="form-group">
                        <label for="rut" class="col-lg-4 control-label">Rut persona <span class="require">*</span></label>
                        <div class="col-lg-8">
                          <input type="text" class="form-control" id="rut" name="rut" required="">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="nombre" class="col-lg-4 control-label">Nombre completo <span class="require">*</span></label>
                        <div class="col-lg-8">
                          <input type="text" class="form-control" id="nombre" name="nombre" required="">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="mail" class="col-lg-4 control-label">Email de contacto <span class="require">*</span></label>
                        <div class="col-lg-8">
                          <input type="email" class="form-control" id="mail" name="mail" required="">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="estado" class="col-lg-4 control-label">Estado civil <span class="require">*</span></label>
                        <div class="col-lg-8">
                          <input type="text" class="form-control" id="estado" name="estado" required="">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="direccion" class="col-lg-4 control-label">Direccion completa <span class="require">*</span></label>
                        <div class="col-lg-8">
                    ...
                    <fieldset>
                      <legend>Clave para certificado digital</legend>
                      <div class="form-group">
                        <label for="clave" class="col-lg-4 control-label">Clave <span class="require">*</span></label>
                        <div class="col-lg-8">
                    ...
                    <fieldset>
                      <legend>Numero de serie/Documento de Cédula </legend>
                      <div class="form-group">
                        <label for="ci" class="col-lg-4 control-label">Serie <span class="require">*</span></label>
                        <div class="col-lg-8">
                    ...
                    <div class="row">
                      <div class="col-lg-8 col-md-offset-4 padding-left-0 padding-top-20">                        
                        <button type="submit" class="btn btn-primary">Solicitar certificado digital</button>
                        <a href="certificado-digital.html" class="btn btn-default">Cancelar</a>
                      </div>
                    </div>
                  </form>
                </div>
                <div class="col-md-4 col-sm-4 pull-right">
                  <div class="form-info">
                    <h2> Información <em>Importante</em></h2>
                    <p>Se enviará un email de confirmación a su correo electrónico con los valores y pasos a seguir para finalizar la solicitud, si usted no completa las instrucciones enviadas, su solicitud no tendrá efecto.</p>

                    <p>Una vez enviada la solicitud, usted deberá ir a su cuenta y registrar su pago vía online a través de nuestro sitio.</p>

                    <p>Después de 24 horas hábiles, llegará a su correo el certificado digital e inmediatamente póngase en contacto con uno de nuestros técnicos para que realice la instalación en su equipo vía remota.</p>
