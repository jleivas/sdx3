    ...
    <head>
      <meta charset="utf-8">
      <title>La digitalización y el medio ambiente</title>
      <script>
      ...
      <meta property="og:title" content="La digitalización y el medio ambiente">
      <meta property="og:description" content="La digitalización y el medio ambiente">
      <meta property="og:type" content="website">
      <meta property="og:image" content="https://www.softdirex.cl/assets/pages/img/posts/img17.png"><!-- link to image for socio -->
      <meta property="og:url" content="https://www.softdirex.cl/2017/11/01/la-digitalizacin-y-el-medio-ambiente.php">
            ...
            <div class="col-md-12 col-sm-12">
              <!-- Inicio Contenido principal   ------------------------------------------------>
                <div id="containerRight">            
                        ...
                        <div class="front-carousel">
                          <div id="myCarousel" class="carousel slide">
                            ...
                            <div class="item active">
                                <img src=<?php echo $rootUri."/assets/pages/img/posts/img17.png"; ?> alt="">
                            </div>
                    
                            <div class="item">
                                <img src=<?php echo $rootUri."/assets/pages/img/posts/img18.jpg"; ?> alt="">
                            </div>
                    
                            <div class="item">
                                <img src=<?php echo $rootUri."/assets/pages/img/posts/img19.jpg"; ?> alt="">
                            </div>
                    ...
                    <p>La digitalización de documentos ayuda a prevenir pérdidas y a recuperar la información rápidamente. Al tener los registros vitales respaldados y en formato digital; los datos quedan completamente resguardados.<br />
<br />
Pero no sólo trae beneficios para tu empresa, también ayudas a disminuir la producción de gases contaminantes.</p>
                    ...
                    <small>Impacto ambiental de la fabricación y consumo del papel
                        <cite>
                        <a href="" >Ecología Verde</a></cite></small></blockquote>
                        ...
                        <p>Softdirex tiene como misión disminuir el uso del papel para sus documentos, para ello existen diversas herramientas digitales que puede emplear en tu empresa, desde facturación electrónica hasta un simple comprobante, has como Softdirex y comprométete con el medio ambiente.</p>
                                ...
                                <br><br><p> <a href="https://www.ecologiaverde.com/impacto-ambiental-de-la-fabricacion-y-consumo-del-papel/" target="_blank">Fuente:Ecología Verde</a></p>
                                <div>
                        ...
                        href="https://twitter.com/intent/tweet?text=La digitalización y el medio ambiente @softdirex">
                        Tweet</a>

                        <script src="//platform.linkedin.com/in.js" type="text/javascript"> lang: es_ES</script>
                        <script type="IN/Share" data-url="https://www.softdirex.cl/2017/11/01/la-digitalizacin-y-el-medio-ambiente.php"></script>
                        
                        <div class="fb-like" data-href="https://www.softdirex.cl/2017/11/01/la-digitalizacin-y-el-medio-ambiente.php" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
                        
                        <a href="https://api.whatsapp.com/send?text=Me%20gustaría%20compartirte%20esta%20info%20https://www.softdirex.cl/2017/11/01/la-digitalizacin-y-el-medio-ambiente.php" style="border-radius: 7px; -moz-border-radius: 7px; -webkit-border-radius: 7px; display: inline-block; text-decoration: none; text-align: center; font-size: x-small; padding: 4px; color: white; background-color: green;" target="_blank"><i class="fa fa-whatsapp"></i>Compartir</a>

                        </div>
                    <ul class="blog-info">
                    <li><i class="fa fa-user"></i> Jorge Leiva - CEO Softdirex</li>
                    <li><i class="fa fa-calendar"></i>2017-11-01</li>
                    </ul>
                    <h2>Comentarios</h2>
                  <div class="comments">
                    <?php
                  ...
                  <div class="post-comment padding-top-40">
                    ...
                    <form role="form" action="../../../int/fn/comentar.php" method="post">
                      <div class="form-group">
                        ...
                        <input type="hidden" name="link" id="link" value="https://www.softdirex.cl/2017/11/01/la-digitalizacin-y-el-medio-ambiente.php">
                      </div>
