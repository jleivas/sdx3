...
$misRegistros=ProyectoDao::sqlCliente($usuario1->getRut());// es el resultado en Array del select * from publicacion
...
<head>
  <meta charset="utf-8">
  <title>Mis proyectos - Softdirex</title>
  <script>
        ...
        <div class="row margin-bottom-40">
          ...
          <div class="col-md-12 col-sm-12">
            ...
            <div class="content-page">
                <div class="filter-v1">
                  <ul class="mix-filter">
                    <a href=""><li data-filter="all" class="filter active">Todos mis proyectos</li></a>
                  </ul>
                                ...
                                <?php
                                  ...
                                  foreach ($misRegistros as $fila) {
                                    ...
                                    if($fila['proy_categoria'] == 3){
                                        $cat="Aplicación de escritorio";
                                    }
                                    if($fila['proy_categoria'] == 4){
                                        $cat="Diseño gráfico";
                                    }
                                    if($fila['proy_categoria'] == 5){
                                        $cat="Otros servicios";
                                    }
                                ?>
                                  
                                  <div class="col-md-3 col-sm-4">
                                  <a href="<?php echo $fila['proy_link']; ?>" target="_blank" class="">
                                  <div class="mix <?php echo $cat; ?> mix_all" style="display: block; opacity: 1; ">
                                    ...
                                    <div class="mix-inner">
                                       ...
                                       <div class="mix-details">
                                          ...
                                          <h5><?php echo $cat; ?></h5>
                                          <h5>Valor <?php echo "$".number_format($fila['proy_monto']); ?></h5>
                                  ...
                                  <form action="verInforme.php" method="post">
                                    ...
                                    <input type="submit" class="btn btn-primary" name="" value="Ver informes">
                                  </form>                      
                                  </div>
