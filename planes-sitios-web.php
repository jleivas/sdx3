...
<head>
  <meta charset="utf-8">
  <title>Planes sitios web - Softdirex</title>
  <script>
          ...
          <ul>
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                <li class="active"><a href="sitios-web.html">Sitios web</a></li>
                ...
                <div class="col-md-4">
                  <div class="pricing hover-effect">
                    <div class="pricing-head">
                      <h3>Express
                      <span>
                         Anual $57.990+iva <strong>(Ahorro 30%)</strong>
                      </span>
                      </h3>
                      <h4><i>$</i>6.300<i>+iva</i>
                      <span>
                         Mensual
                      </span>
                      </h4>
                    ...
                    <ul class="pricing-content list-unstyled">
                      <li>
                        <i class="fa fa-cloud"></i> Hosting profesional 1GB.
                      </li>
                      <li>
                        <i class="fa fa-asterisk"></i> Incluye registro de dominio.
                      </li>
                      <li>
                        <i class="fa fa-desktop"></i> Hasta 4 páginas.
                      </li>
                      <li>
                        <i class="fa fa-mobile"></i> Compatible con dispositivos móviles.
                      </li>
                      <li>
                        <i class="fa fa-edit"></i> 1 Formulario de contacto.
                      </li>
                      <li>
                        <i class="fa fa-file-image-o"></i> 1 Galería de imágenes.
                      </li>
                      <li>
                        <i class="fa fa-cloud-download"></i> Datos 100% respaldados.
                      </li>
                      <li>
                        <i class="fa fa-refresh"></i> Actualización de datos una vez al mes.
                      </li>
                      <li>
                        <i class="fa fa-life-ring"></i> Soporte y administración continua.
                      </li>
                    </ul>
                ...
                <div class="col-md-4">
                  <div class="pricing pricing-active hover-effect">
                    <div class="pricing-head pricing-head-active">
                      <h3>Plus
                      <span>
                         Anual $157.990+iva <strong>(Ahorro 40%)</strong>
                      </span>
                      </h3>
                      <h4><i>$</i>18.490<i>+iva</i>
                      <span>
                         Mensual
                      </span>
                      </h4>
                    ...
                    <ul class="pricing-content list-unstyled">
                      <li>
                        <i class="fa fa-cloud"></i> Hosting profesional 3GB.
                      </li>
                      <li>
                        <i class="fa fa-asterisk"></i> Incluye registro de dominio.
                      </li>
                      <li>
                        <i class="fa fa-envelope-o"></i> Hasta 15 cuentas de correo electrónico.
                      </li>
                      <li>
                        <i class="fa fa-desktop"></i> Hasta 10 páginas.
                      </li>
                      <li>
                        <i class="fa fa-mobile"></i> Compatible con dispositivos móviles.
                      </li>
                      <li>
                        <i class="fa fa-edit"></i> Formularios ilimitados.
                      </li>
                      <li>
                        <i class="fa fa-file-image-o"></i> Galerías de imágenes.
                      </li>
                      <li>
                        <i class="fa fa-cloud-download"></i> Datos 100% respaldados.
                      </li>
                      <li>
                        <i class="fa fa-refresh"></i> Actualización de datos una vez por semana.
                      </li>
                      <li>
                        <i class="fa fa-life-ring"></i> Soporte y administración continua.
                      </li>
                ...
                <div class="col-md-4">
                  <div class="pricing hover-effect">
                    <div class="pricing-head">
                      <h3>Premium
                      <span>
                         Anual $297.990+iva <strong>(Ahorro 50%)</strong>
                      </span>
                      </h3>
                      <h4><i>$</i>37.290<i>+iva</i>
                      <span>
                         Mensual
                      </span>
                      </h4>
                    ...
                    <ul class="pricing-content list-unstyled">
                      <li>
                        <i class="fa fa-cloud"></i> Hosting profesional 10GB.
                      </li>
                      <li>
                        <i class="fa fa-asterisk"></i> Incluye registro de dominio.
                      </li>
                      <li>
                        <i class="fa fa-envelope-o"></i> Hasta 80 cuentas de correo electrónico.
                      </li>
                      <li>
                        <i class="fa fa-desktop"></i> Páginas ilimitadas.
                      </li>
                      <li>
                        <i class="fa fa-mobile"></i> Compatible con dispositivos móviles.
                      </li>
                      ...
                      <li>
                        <i class="fa fa-refresh"></i> Actualización de datos todos los días.
                      </li>
                      <li>
                        <i class="fa fa-google"></i> Google analytics.
                      </li>
                      <li>
                        <i class="fa fa-buysellads"></i> Anuncios con Google AdWords (Incluye costos adicionales).
                      </li>
                      <li>
                        <i class="fa fa-life-ring"></i> Soporte y administración continua.
                      </li>
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-sm-4">
            <ul class="social-footer list-unstyled list-inline pull-right">
              <li><a href="http://fb.me/Softdirex"><i class="fa fa-facebook"></i></a></li>
              <li><a href="https://www.linkedin.com/company-beta/25005966/"><i class="fa fa-linkedin"></i></a></li>
              <li><a href="https://twitter.com/softdirex"><i class="fa fa-twitter"></i></a></li>
              <li><a href="https://join.skype.com/BzouJnZA7VBn"><i class="fa fa-skype"></i></a></li>
              <li><a href="https://www.youtube.com/channel/UC-yzBUF_mKFUgQCEp5wmadg"><i class="fa fa-youtube"></i></a></li>
            </ul>  
          </div>
          <!-- END PAYMENTS -->
          <!-- BEGIN POWERED -->
