...
<head>
  <meta charset="utf-8">
  <title>Registrar Informe - Softdirex</title>
  <script>
            ...
            <div class="content-form-page">
              <div class="row">
                <div class="col-md-7 col-sm-7">
                  <form action="int/fn/admProyecto-informe.php" class="form-horizontal" role="form" method="post">
                    <fieldset>
                      <legend>Nuevo Informe para <?php echo $proy->getNombre(); ?></legend>
                      <div class="form-group">
                        <label for="autor" class="col-lg-4 control-label">Autor <span class="require">*</span></label>
                        <div class="col-lg-8">
                          <input type="text" class="form-control" id="autor" name="autor" value="<?php echo $usuario1->getNombre(); ?>"  minlength="10" maxlength="60" required="">
                          <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $proy->getId(); ?>" required="">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-8">
                          <input type="text" class="form-control" id="titulo" name="titulo" minlength="4" maxlength="60" required="">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="informe" class="col-lg-4 control-label">Informe</label>
                        <div class="col-lg-8">
                          <textarea class="form-control" name="informe" rows="10" required></textarea>
                        </div>
                      </div>
                    </fieldset>
