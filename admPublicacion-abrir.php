...
<head>
  <meta charset="utf-8">
  <title>Publicación - Softdirex</title>
  <script>
          ...
          <ul>
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                <li class="active"><a href="admPublicaciones-mostrar.php">Mostrar</a></li>
    ...
    <div class="main">
      <div class="container">
        <ul class="breadcrumb">
            ...
            <li><a href="admPublicaciones-mostrar.php">Publicaciónes</a></li>
        ...
        <div class="row margin-bottom-40">
          ...
          <div class="sidebar col-md-3 col-sm-3">
            <ul class="list-group margin-bottom-25 sidebar-menu">
              <li class="list-group-item clearfix"><a href="admPublicaciones-mostrar.php"><i class="fa fa-angle-right"></i> Mostrar</a></li>
              <li class="list-group-item clearfix"><a href="admPublicaciones-registrar.php"><i class="fa fa-angle-right"></i> Registrar</a></li>
              <li class="list-group-item clearfix"><a href="admPublicaciones-comentarios.php"><i class="fa fa-angle-right"></i> Comentarios</a></li>
              <li class="list-group-item clearfix"><a href="admPublicaciones-suscriptores.php"><i class="fa fa-angle-right"></i>Suscriptores</a></li>
              <li class="list-group-item clearfix"><a href="admPublicaciones-enviar.php"><i class="fa fa-angle-right"></i>Enviar Boletín</a></li>
          ...
          <div class="col-md-9 col-sm-9">
            <h1>Gesionar datos de publicación</h1>
            <div class="content-form-page">
              <div class="row">
                <div class="col-md-7 col-sm-7">
                  <h2>Actualizar datos</h2>
                  <form action="int/fn/admPublicaciones-actualizar.php" class="form-horizontal" role="form" method="post"><!-- registroMail.php -->
                    <fieldset>
                      <legend>Proyecto</legend>
                      <div class="form-group">
                        <label for="link" class="col-lg-4 control-label">Link de acceso </label>
                        <div class="col-lg-8">
                          <input type="hidden" class="form-control" id="link" name="link"  minlength="10" maxlength="100" value="<?php echo $blog->getLink();?>" required="">
                          <input type="text" class="form-control" id="link2" name="link2"  minlength="10" maxlength="100" value="<?php echo $blog->getLink();?>" required="">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="titulo" class="col-lg-4 control-label">Titulo </label>
                        <div class="col-lg-8">
                          <input type="text" class="form-control" id="titulo" name="titulo" value="<?php echo $blog->getTitulo();?>" minlength="3" maxlength="60" required="" readonly="readonly">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="cita" class="col-lg-4 control-label">Cita o parte del texto</label>
                        <div class="col-lg-8">
                          <textarea class="form-control" rows="10" name="cita"><?php echo $blog->getCita();?></textarea>
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="imagen" class="col-lg-4 control-label">Link de imagen </label>
                        <div class="col-lg-8">
                          <input type="text" class="form-control" id="imagen" name="imagen"  minlength="10" maxlength="60" value="<?php echo $blog->getImagen();?>" required="">
                        </div>
                      </div>
                    </fieldset>
