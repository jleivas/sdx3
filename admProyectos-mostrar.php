...
$misRegistros = ProyectoDao::sqlTodo();
}else{

$misRegistros = ProyectoDao::sqlEstado($estado);
}
...
<head>
  <meta charset="utf-8">
  <title>Proyectos - Softdirex</title>
  <script>
      ...
      <div class="container">
        ...
        <div class="row margin-bottom-40">
          ...
          <div class="col-md-12 col-sm-12">
            <h1>Mostrar Proyectos</h1>
            <a href="admProyectos-mostrar.php?estado=-1" class="btn btn-info">Todos</a>&nbsp;&nbsp;&nbsp;
            <a href="admProyectos-mostrar.php?estado=1" class="btn btn-success">Finalizados</a>&nbsp;&nbsp;&nbsp;
            <a href="admProyectos-mostrar.php?estado=0" class="btn btn-danger">Eliminados</a>&nbsp;&nbsp;&nbsp;
            <hr>
          </div>
          ...
          <div class="col-md-12 col-sm-12">
              <table>
                ...
                ?>
                <tr>
                  <form action="int/fn/admProyecto-modificar.php" method="post">
                  <td>
                    <a href="<?php echo $fila['proy_link']; ?>" title="Abrir proyecto en portafolio" class="btn btn-success" target="_blank">Ir</a>
                    <input type="hidden" name="link" value="<?php echo $fila['proy_link']; ?>" required="required">
                  </td>
                  <td><input type="text" name="nombre" value="<?php echo $fila['proy_nombre']; ?>" required="required"></td>
                  <td><?php echo "$".number_format($fila['proy_monto']); ?></td>
                  <td><?php echo "$".number_format($fila['proy_saldo']); ?></td>
                  <td>
                    <select name="categoria" onChange="javascript:alert('Categoria modificada');">
                      <?php
                      if($fila['proy_categoria']==1){
                      ?>
                      <option selected value="1">Sitios Web</option>
                      <?php
                      }else{
                      ?>
                      <option value="1">Sitios Web</option>
                      <?php
                      }if($fila['proy_categoria']==2){
                      ?>
                      <option selected value="2">Aplicaciones Web</option>
                      <?php
                      }else{
                      ?>
                      <option value="2">Aplicaciones Web</option>
                      <?php
                      }if($fila['proy_categoria']==3){
                      ?>
                      <option selected value="3">Aplicaciones de escritorio</option>
                      <?php
                      }else{
                      ?>
                      <option value="3">Aplicaciones de escritorio</option>
                      <?php
                      }if($fila['proy_categoria']==4){
                      ?>
                      <option selected value="4">Diseño Gráfico</option>
                      <?php
                      }else{
                      ?>
                  ...
                  <td><input type="text" name="cliente" value="<?php echo $fila['cliente_cli_rut']; ?>"></td>
                  <td>
                    <?php
                    if($estado!=0){
                    ?>
                  ...
                  <td>
                    ...
                    if($estado!=0){
                    ?>
                    <form action="admProyecto-abrir.php" method="post">
                      <input type="hidden" name="link" value="<?php echo $fila['proy_link']; ?>">
                      <button type="submit" class="btn-success">Gestionar</button>
                    </form>
                    <?php
                    }else{
                    ?>
                    <a href="" class="btn-default" onclick="javascript:alert('No se puede gestionar un dato eliminado');">Gestionar</a>
                    <?php
                    }
                    ?>
                  </td>
                  ...
                  <?php
                    if($estado!=0){
                    ?>
                    <form action="admProyecto-informe.php" method="post">
                      <input type="hidden" name="link" value="<?php echo $fila['proy_link']; ?>">
                      <button type="submit" class="btn-success">Informe</button>
                    </form>
                    <?php
                    }else{
                    ?>
                    <a href="" class="btn-default" onclick="javascript:alert('No se puede gestionar un dato eliminado');">Informe</a>
                    <?php
                    }
                    ?>
                  </td>
                  <td>
                    ...
                    if($estado!=0){
                    ?>
                    <form action="int/fn/admProyecto-anular.php" method="post">
                      <input type="hidden" name="link" value="<?php echo $fila['proy_link']; ?>">
                    ...
                    ?>
                    <form action="int/fn/admProyecto-restaurar.php" method="post">
                      <input type="hidden" name="link" value="<?php echo $fila['proy_link']; ?>">
