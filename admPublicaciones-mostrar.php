...
$misRegistros = BlogDao::sqlEstado($estado);
...
<head>
  <meta charset="utf-8">
  <title>Publicaciones - Softdirex</title>
  <script>
      ...
      <div class="container">
        ...
        <div class="row margin-bottom-40">
          ...
          <div class="col-md-12 col-sm-12">
            ...
            <a href="admPublicaciones-mostrar.php?estado=1" class="btn btn-success">Activas</a>&nbsp;&nbsp;&nbsp;
            <a href="admPublicaciones-mostrar.php?estado=0" class="btn btn-danger">Anuladas</a>&nbsp;&nbsp;&nbsp;
            <hr>
          </div>
          ...
          <div class="col-md-12 col-sm-12">
              <table>
                ...
                ?>
                <tr>
                  <form action="int/fn/admPublicacion-modificar.php" method="post">
                  <td>
                    <a href="<?php echo $fila['blo_link']; ?>" title="Abrir publicación en noticias" class="btn btn-success" target="_blank">Ir</a>
                    <input type="hidden" name="link" value="<?php echo $fila['blo_link']; ?>" required="required">
                  </td>
                  <td><input type="text" name="titulo" value="<?php echo $fila['blo_titulo']; ?>" required="required"></td>
                  <td><input type="text" name="autor" value="<?php echo $fila['blo_autor']; ?>" required="required"></td>
                  <td><input type="date" name="fecha" value="<?php echo $fila['blo_fecha']; ?>" required="required"></td>
                  <td>
                    <select name="categoria" onChange="javascript:alert('Categoria modificada');">
                      <?php
                      if($fila['blo_categoria']==1){
                      ?>
                      ...
                      <?php
                      }if($fila['blo_categoria']==2){
                      ?>
                      <option selected value="2">Sistemas</option>
                      <?php
                      }else{
                      ?>
                      <option value="2">Sistemas</option>
                      <?php
                      }if($fila['blo_categoria']==3){
                      ?>
                      <option selected value="3">Tecnología</option>
                      <?php
                      }else{
                      ?>
                      <option value="3">Tecnología</option>
                      <?php
                      }if($fila['blo_categoria']==4){
                      ?>
                      <option selected value="4">Proyectos</option>
                      <?php
                      }else{
                      ?>
                      <option value="4">Proyectos</option>
                      <?php
                      }if($fila['blo_categoria']==5){
                      ?>
                      <option selected value="5">Móviles</option>
                      <?php
                      }else{
                      ?>
                  ...
                  <td>
                    ...
                    if($estado!=0){
                    ?>
                    <form action="admPublicacion-abrir.php" method="post">
                      <input type="hidden" name="link" value="<?php echo $fila['blo_link']; ?>">
                  ...
                  <td>
                    ...
                    if($estado!=0){
                    ?>
                    <form action="int/fn/admPublicacion-anular.php" method="post">
                      <input type="hidden" name="link" value="<?php echo $fila['blo_link']; ?>">
                    ...
                    ?>
                    <form action="int/fn/admPublicacion-restaurar.php" method="post">
                      <input type="hidden" name="link" value="<?php echo $fila['blo_link']; ?>">
