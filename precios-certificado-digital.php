...
<head>
  <meta charset="utf-8">
  <title>Precios Certificado digital - Softdirex</title>
  <script>
      ...
      <div class="container">
        ...
        <div class="row margin-bottom-40">
          ...
          <div class="col-md-12 col-sm-12">
            <h1>Precios por certificado digital <small>Duración un año</small></h1>
            <div class="content-page">
              <div class="row margin-bottom-40">
                ...
                <div class="col-md-3">
                  <div class="pricing hover-effect">
                    <div class="pricing-head">
                      ...
                      <h4><i>$</i>17.900<i>+iva</i>
                      <span>La instalación se hace a parte</span>
                      </h4>
                    </div>
                ...
                <div class="col-md-3">
                  <div class="pricing hover-effect">
                    <div class="pricing-head">
                      ...
                      <h4><i>$</i>15.000<i>+iva</i>
                      <span>La compra se hace a parte</span>
                      </h4>
                    </div>
                    <ul class="pricing-content list-unstyled">
                    </ul>
                ...
                <div class="col-md-3">
                  <div class="pricing hover-effect">
                    <div class="pricing-head">
                      ...
                      <h4><i>$</i>17.900<i>+iva</i>
                      <span>Previa compra del cerificado</span>
                      </h4>
                    </div>
                    <ul class="pricing-content list-unstyled">
                    </ul>
                ...
                <div class="col-md-3">
                  <div class="pricing hover-effect">
                    <div class="pricing-head">
                      <h3>Compra e instalación
                      <span>
                         Remota
                      </span>
                      </h3>
                      <h4><i>$</i>30.000<i>+iva</i>
                      </h4>
                    </div>
                    <ul class="pricing-content list-unstyled">
                    </ul>
