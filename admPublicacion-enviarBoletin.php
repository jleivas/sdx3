...
$url="admPublicacion-enviarBoletin.php";
//INICIO Paginación
...
<head>
  <meta charset="utf-8">
  <title>Enviar Boletín - Softdirex</title>
  <script>
          ...
          <ul>
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a href="admPublicaciones-enviar.php">Enviar boletín</a></li>
              </ul>
            </li>
            ...
            <li class="menu-search">
              ...
              <div class="search-box">
                <form action="admPublicacion-enviarBoletin.php?link=<?php echo $link; ?>" method="post">
      ...
      <div class="container">
        ...
        <div class="row margin-bottom-40">
          ...
          <div class="col-md-12 col-sm-12">
            <h1>Enviar publicación: <?php echo $blog->getTitulo(); ?></h1>
            <hr>
          </div>
          ...
          <div class="col-md-12 col-sm-12">
              <table>
                ...
                ?>
                <tr>
                  <form action="int/fn/enviarCorreo.php" method="post">
                  <td><?php echo $fila['corr_correo']; ?><input type="hidden" name="id"  value="<?php echo $fila['corr_correo']; ?>" readonly="readonly"><input type="hidden" name="link"  value="<?php echo $blog->getLink(); ?>" readonly="readonly"></td>
                  <td><input type="submit" name="" class="btn-mini btn-success" value="Enviar"></td>
                </form>
                </tr>
                <?php
                }
              ...
              <ul class="pagination">
                  ...
                  if ($total_paginas > 1) {
                     if ($pagina != 1)
                        echo '<li><a href="'.$url.'?pagina='.($pagina-1).'&link='.$link.'">Anterior</a></li>';
                        
                        for ($i=1;$i<=$total_paginas;$i++) {
                           if ($pagina == $i)
                              //si muestro el índice de la página actual, no coloco enlace
                            echo '<li class="active"><a href="'.$url.'?pagina='.$pagina.'&link='.$link.'">'.$pagina.'</a></li>';
                            
                           else{
                              echo '<li><a href="'.$url.'?pagina='.$i.'&link='.$link.'">'.$i.'</a></li>';
                            }
                        }
                        if ($pagina != $total_paginas){
                          echo '<li><a href="'.$url.'?pagina='.($pagina+1).'&link='.$link.'">Siguiente</a></li>';
                         }
                  }
                  ?>
                  </ul>    
