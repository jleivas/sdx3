          ...
          <div class="col-md-12 col-sm-12">
            ...
            <div class="content-page">
              <div class="row margin-bottom-30">
                    ...
                    <div class="carousel-inner">
                      <div class="item">
                        ...
                        <div class="carousel-caption">
                          <p>Registro y administración de ventas e inventario.</p>
                        </div>
                      </div>
                      <div class="item active">
                        <img alt="" src="../assets/pages/img/works/sdxf2.jpg">
                        <div class="carousel-caption">
                          <p>Calculo de pagos por semana.</p>
                        </div>
                      </div>
                      <div class="item">
                        <img alt="" src="../assets/pages/img/works/sdxf3.jpg">
                        <div class="carousel-caption">
                          <p>Gestión de venta de plantas.</p>
                        </div>
                      </div>
                    </div>
                    <!-- Carousel nav -->
                ...
                <div class="col-md-7">
                  <h2>Registro de ventas e inventario</h2>
                  <p>Fertz versión 1.0 es la primera de su generación, un software de registro de plantas para viveros.</p>
                  <p>Nos permite registrar ventas, descontra automáticamente el inventario, notificar plantas en cantidades reducidas para reponer y nos mantiene ordenados los registros de venta por fecha.</p>
                  <p>No requiere de claves de acceso, aunque se proyecta añadirlo en una nueva versión.</p>
                  <p>
                    Al igual que SoftManager v1.0, no requiere de internet para su funcionamiento, a menos que el administrador del sistema desee respaldar los datos, esto no requiere de mucho trabajo, solo basta con seleccionar en el menú la opción "Respaldar los datos" e inmediatamente se creará un archivo con toda la información de la base de datos, además, si el equipo tiene acceso a internet, se enviará un respaldo a nuestros registros vía online para mayor seguridad.
                  </p>
                  <br>
                  <div class="row front-lists-v2 margin-bottom-15">
                    <div class="col-md-6">
                      <ul class="list-unstyled">
                        <li><i class="fa fa-check"></i> Respaldo de información sin límites</li>
                        <li><i class="fa fa-check"></i> Fácil de usar</li>
                        <li><i class="fa fa-check"></i> No consume recursos del sistema</li>
                        <li><i class="fa fa-check"></i> Base de datos local</li>
                      </ul>
                    </div>
                    <div class="col-md-6">
                      <ul class="list-unstyled">
                        <li><i class="fa fa-check"></i> No necesita conexión a internet</li>
                        <li><i class="fa fa-check"></i> Soporte remoto gratis por un año</li>
                        <li><i class="fa fa-check"></i> Visitas técnicas con costo adicional</li>
                        <li><i class="fa fa-check"></i> Escoge el plan que te acomode (mensual o anual)</li>
                      </ul>
                    </div>
                  </div>
                </div>
