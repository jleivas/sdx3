            ...
            <div class="content-page">
              <div class="row margin-bottom-30">
                ...
                <div class="col-md-5 front-carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="item">
                        ...
                        <div class="carousel-caption">
                          <p>Página principal con formulario de reserva de vehiculos.</p>
                        </div>
                      </div>
                      <div class="item active">
                        <img alt="" src="../assets/pages/img/works/img2.jpg">
                        <div class="carousel-caption">
                          <p>Vitrina de vehiculos disponibles por la empresa.</p>
                        </div>
                      </div>
                      <div class="item">
                        <img alt="" src="../assets/pages/img/works/img3.jpg">
                        <div class="carousel-caption">
                          <p>Página principal del sitio con las características del servicio.</p>
                        </div>
                      </div>
                    </div>
                    <!-- Carousel nav -->
                  ...
                  <hr>
                  <div align="center"><iframe src="http://www.magallanesrentacar.cl/index.html" width=450 height=350 frameborder=1 scrolling=auto></iframe></div>              
                </div>
                <!-- END CAROUSEL -->                             

                <!-- BEGIN PORTFOLIO DESCRIPTION -->            
                <div class="col-md-7">
                  <h2>Servicio de arriendo de vehiculos en Puerto Natales</h2>

                  <p>Esta empresa, del sur de Chile, se encarga de arrendar vehiculos para turistas, empresarios, amigos, etc..
                  </p>
                  <p>Se creó una versión en español y otra en inglés para llegar a la mayor cantidad de posibles clientes, en el sitio web se pueden hacer las reservas de vehiculos con anticipacion..</p>
