          ...
          <div class="col-md-12 col-sm-12">
            ...
            <div class="content-page">
              <div class="row margin-bottom-30">
                  ...
                  <div class="carousel slide" id="myCarousel">
                    ...
                    <div class="carousel-inner">
                      ...
                      <div class="item active">
                        <img alt="" src="../assets/pages/img/works/swapr2.jpg">
                        <div class="carousel-caption">
                          <p>Nuestros clientes pueden publicar en el sitio web anuncios relacionados con su servicio.</p>
                        </div>
                      </div>
                      <div class="item">
                        <img alt="" src="../assets/pages/img/works/swapr3.jpg">
                        <div class="carousel-caption">
                          <p>Descripción de las características del sitio.</p>
                        </div>
                      </div>
                    </div>
                    <!-- Carousel nav -->
                ...
                <div class="col-md-7">
                  <h2>Sitio web de APR Colonia Kennedy</h2>

                  <p>El sitio web consta de las características comunes de las páginas corporativas, resaltan entre sus funciones, una galería de imágenes, una sección de descargas y un apartado de anuncios en donde el servicio comunica noticias y anuncios relacionados al rubro.</p>
