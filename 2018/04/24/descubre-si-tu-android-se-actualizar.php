    ...
    <head>
      <meta charset="utf-8">
      <title>Descubre si tu android se actualizará</title>
      <script>
      ...
      <meta property="og:title" content="Descubre si tu android se actualizará">
      <meta property="og:description" content="Descubre si tu android se actualizará">
      <meta property="og:type" content="website">
      <meta property="og:image" content="https://www.softdirex.cl/assets/pages/img/posts/Android-8.0-Galaxy-S8.jpg"><!-- link to image for socio -->
      <meta property="og:url" content="https://www.softdirex.cl/2018/04/24/descubre-si-tu-android-se-actualizar.php">
            ...
            <div class="col-md-12 col-sm-12">
              <!-- Inicio Contenido principal   ------------------------------------------------>
                <div id="containerRight">            
                        ...
                        <div class="front-carousel">
                          <div id="myCarousel" class="carousel slide">
                            ...
                            <div class="item active">
                                <img src=<?php echo $rootUri."/assets/pages/img/posts/Android-8.0-Galaxy-S8.jpg"; ?> alt="">
                            </div>
                    
                            <div class="item">
                                <img src=<?php echo $rootUri."/assets/pages/img/posts/maxresdefault.jpg"; ?> alt="">
                            </div>
                    
                            <div class="item">
                                <img src=<?php echo $rootUri."/assets/pages/img/posts/oreo-lg-kzCB--620x349@abc.jpg"; ?> alt="">
                            </div>
                    ...
                    <h2><a href="">Descubre si tu android se actualizará</a></h2>
                    
                    <p>Ya es sabido que cada cierto periodo de tiempo aparece una nueva versión mejorada de tan conocido sistema operativo, junto con él, se asoma la incertidumbre de si mi smartphone será capaz de actualizarse.</p>
                    
                    <blockquote>
                        <p>“Muchos móviles android comenzarán a actualizarse a la última versión de Android, me refiero a Android Oreo 8.0, ¿Quieres saber si tu smartphone está dentro de la lista de los confirmados por Google?”.</p>
                    
                    <small>Jorge Leiva
                        <cite>
                        <a href="" >CEO Softdirex</a></cite></small></blockquote>
                        
                        <p>Xatakandroid ha publicado un listado con todos los smartphones que tendrán disponible la última versión de Android Oreo, según Xakatandroid, la lista estará siendo actualizada constantemente, aseguran estar recabando las confirmaciones de actualización o no actualización así como todos los rumores.<br />
<br />
<a href="https://www.xatakandroid.com/sistema-operativo/se-actualizara-mi-movil-a-android-8-0-oreo-la-lista-definitiva" target="_blank">Revisa la lista de fabricantes aqui.</></p>
                        
                                <br><br><p> <a href="https://www.xatakandroid.com/" target="_blank">Fuente:Xakatandroid</a></p>
                                <div>
                        ...
                        href="https://twitter.com/intent/tweet?text=Descubre si tu android se actualizará @softdirex">
                        Tweet</a>

                        <script src="//platform.linkedin.com/in.js" type="text/javascript"> lang: es_ES</script>
                        <script type="IN/Share" data-url="https://www.softdirex.cl/2018/04/24/descubre-si-tu-android-se-actualizar.php"></script>
                        
                        <div class="fb-like" data-href="https://www.softdirex.cl/2018/04/24/descubre-si-tu-android-se-actualizar.php" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
                        
                        <a href="https://api.whatsapp.com/send?text=Me%20gustaría%20compartirte%20esta%20info%20https://www.softdirex.cl/2018/04/24/descubre-si-tu-android-se-actualizar.php" style="border-radius: 7px; -moz-border-radius: 7px; -webkit-border-radius: 7px; display: inline-block; text-decoration: none; text-align: center; font-size: x-small; padding: 4px; color: white; background-color: green;" target="_blank"><i class="fa fa-whatsapp"></i>Compartir</a>

                        </div>
                    <ul class="blog-info">
                    <li><i class="fa fa-user"></i> Jorge Leiva - CEO Softdirex</li>
                    <li><i class="fa fa-calendar"></i>2018-04-24</li>
                    </ul>
                    <h2>Comentarios</h2>
                  <div class="comments">
                    <?php
                  ...
                  <div class="post-comment padding-top-40">
                    ...
                    <form role="form" action="../../../int/fn/comentar.php" method="post">
                      <div class="form-group">
                        ...
                        <input type="hidden" name="link" id="link" value="https://www.softdirex.cl/2018/04/24/descubre-si-tu-android-se-actualizar.php">
                      </div>
