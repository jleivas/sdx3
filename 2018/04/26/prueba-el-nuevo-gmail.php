    ...
    <head>
      <meta charset="utf-8">
      <title>Prueba el nuevo Gmail</title>
      <script>
      ...
      <meta property="og:title" content="Prueba el nuevo Gmail">
      <meta property="og:description" content="Google ha presentado su nueva versión de Gmail">
      <meta property="og:type" content="website">
      <meta property="og:image" content="https://www.softdirex.cl/assets/pages/img/posts/Screenshot_4.png"><!-- link to image for socio -->
      <meta property="og:url" content="https://www.softdirex.cl/2018/04/26/prueba-el-nuevo-gmail.php">
            ...
            <div class="col-md-12 col-sm-12">
              <!-- Inicio Contenido principal   ------------------------------------------------>
                <div id="containerRight">            
                        ...
                        <div class="front-carousel">
                          <div id="myCarousel" class="carousel slide">
                            ...
                            <div class="item active">
                                <img src=<?php echo $rootUri."/assets/pages/img/posts/Screenshot_4.png"; ?> alt="">
                            </div>
                    ...
                    <h2><a href="">Google ha presentado su nueva versión de Gmail</a></h2>
                    
                    <p>Ayer la compañía lanzó la nueva versión de Gmail que se venía anunciando por la web con muchas expectativas.</p>
                    
                    <blockquote>
                        <p>“He actualizado mi Gmail y a simple vista me parece una interfaz muy elegante y útil.<br />
<br />
Me llamó la atención la posibilidad de ver o descargar directamente los archivos adjuntos, además posee un acceso directo al calendario de Google, para organizar nuestra agenda, también me parece muy útil el Google Task del cual se puede sacar mucho provecho para organizar nuestras tareas, organizarlas por prioridad y marcarlas como realizadas.”.</p>
                    
                    <small>Jorge Leiva
                        <cite>
                        <a href="" >CEO Softdirex</a></cite></small></blockquote>
                        
                        <p>Tú también puedes actualizar tu Gmail escritorio en solo dos simples pasos, ve al ícono de configuración en la parte superior derecha y selecciona la primera opción "Probar la nueva versión de Gmail" y listo, explora y disfruta las nuevas características de tu bandeja de entrada que es revolucionaria y moderna.</p>
                        <div>
                        ...
                        href="https://twitter.com/intent/tweet?text=Google ha presentado su nueva versión de Gmail @softdirex">
                        Tweet</a>

                        <script src="//platform.linkedin.com/in.js" type="text/javascript"> lang: es_ES</script>
                        <script type="IN/Share" data-url="https://www.softdirex.cl/2018/04/26/prueba-el-nuevo-gmail.php"></script>
                        
                        <div class="fb-like" data-href="https://www.softdirex.cl/2018/04/26/prueba-el-nuevo-gmail.php" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
                        
                        <a href="https://api.whatsapp.com/send?text=Me%20gustaría%20compartirte%20esta%20info%20https://www.softdirex.cl/2018/04/26/prueba-el-nuevo-gmail.php" style="border-radius: 7px; -moz-border-radius: 7px; -webkit-border-radius: 7px; display: inline-block; text-decoration: none; text-align: center; font-size: x-small; padding: 4px; color: white; background-color: green;" target="_blank"><i class="fa fa-whatsapp"></i>Compartir</a>
                  ...
                  <div class="post-comment padding-top-40">
                    ...
                    <form role="form" action="../../../int/fn/comentar.php" method="post">
                      <div class="form-group">
                        ...
                        <input type="hidden" name="link" id="link" value="https://www.softdirex.cl/2018/04/26/prueba-el-nuevo-gmail.php">
                      </div>
