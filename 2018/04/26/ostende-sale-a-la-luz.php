    ...
    <head>
      <meta charset="utf-8">
      <title>Ostende sale a la luz</title>
      <script>
      ...
      <meta property="og:title" content="Ostende sale a la luz">
      <meta property="og:description" content="Ya ha salido la primera entrega de la herramienta">
      <meta property="og:type" content="website">
      <meta property="og:image" content="https://www.softdirex.cl/assets/pages/img/posts/6.jpg"><!-- link to image for socio -->
      <meta property="og:url" content="https://www.softdirex.cl/2018/04/26/ostende-sale-a-la-luz.php">
            ...
            <div class="col-md-12 col-sm-12">
              <!-- Inicio Contenido principal   ------------------------------------------------>
                <div id="containerRight">            
                        ...
                        <div class="front-carousel">
                          <div id="myCarousel" class="carousel slide">
                            ...
                            <div class="item active">
                                <img src=<?php echo $rootUri."/assets/pages/img/posts/6.jpg"; ?> alt="">
                            </div>
                    
                            <div class="item">
                                <img src=<?php echo $rootUri."/assets/pages/img/posts/3.jpg"; ?> alt="">
                            </div>
                    
                            <div class="item">
                                <img src=<?php echo $rootUri."/assets/pages/img/posts/ostende.png"; ?> alt="">
                            </div>
                    ...
                    <h2><a href="">Ya ha salido la primera entrega de la herramienta</a></h2>
                    
                    <p>Ya ha sido entregada a dos de nuestros clientes a la fecha, Ostende es la nueva forma de trabajar desde la web.</p>
                    
                    <blockquote>
                        <p>“Consiste en un sitio web autoadministrable desde el que se podrá publicar el portafolio en imágenes de nuestros clientes (Eventos, trabajos, productos, etc) todo en un entorno fácil de usar y con soporte todo el año.”.</p>
                    
                    <small>Jorge Leiva
                        <cite>
                        <a href="" >CEO Softdirex</a></cite></small></blockquote>
                        
                        <p>También dispone de una sección donde los usuarios podrán enviar presupuestos de una forma más simple y profesional a sus clientes.<br />
<br />
Este producto dispondrá de un dominio propio y correos electrónicos corporativos ilimitados.<br />
<br />
Ostende es el comienzo de un gran software online para las empresas ya que podrán ir añadiendo funcionalidades a su producto a medida que lo vayan requiriendo.<br />
<br />
Para más info, consulte <a href="http://www.softdirex.cl/page-contacts.html">aquí</a>.</p>
                        <div>
                        ...
                        href="https://twitter.com/intent/tweet?text=Ya ha salido la primera entrega de la herramienta @softdirex">
                        Tweet</a>

                        <script src="//platform.linkedin.com/in.js" type="text/javascript"> lang: es_ES</script>
                        <script type="IN/Share" data-url="https://www.softdirex.cl/2018/04/26/ostende-sale-a-la-luz.php"></script>
                        
                        <div class="fb-like" data-href="https://www.softdirex.cl/2018/04/26/ostende-sale-a-la-luz.php" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
                        
                        <a href="https://api.whatsapp.com/send?text=Me%20gustaría%20compartirte%20esta%20info%20https://www.softdirex.cl/2018/04/26/ostende-sale-a-la-luz.php" style="border-radius: 7px; -moz-border-radius: 7px; -webkit-border-radius: 7px; display: inline-block; text-decoration: none; text-align: center; font-size: x-small; padding: 4px; color: white; background-color: green;" target="_blank"><i class="fa fa-whatsapp"></i>Compartir</a>
                  ...
                  <div class="post-comment padding-top-40">
                    ...
                    <form role="form" action="../../../int/fn/comentar.php" method="post">
                      <div class="form-group">
                        ...
                        <input type="hidden" name="link" id="link" value="https://www.softdirex.cl/2018/04/26/ostende-sale-a-la-luz.php">
                      </div>
