    ...
    <head>
      <meta charset="utf-8">
      <title>Escuchar las notas de voz de tu Whatsapp antes de enviarlas</title>
      <script>
      ...
      <meta property="og:title" content="Escuchar las notas de voz de tu Whatsapp antes de enviarlas">
      <meta property="og:description" content="Tómate un tiempo para pensar antes de enviar un audio">
      <meta property="og:type" content="website">
      <meta property="og:image" content="https://www.softdirex.cl/assets/pages/img/posts/audiowhtsp.jpg"><!-- link to image for socio -->
      <meta property="og:url" content="https://www.softdirex.cl/2018/04/26/escuchar-las-notas-de-voz-de-tu-whatsapp-antes-de-enviarlas.php">
            ...
            <div class="col-md-12 col-sm-12">
              <!-- Inicio Contenido principal   ------------------------------------------------>
                <div id="containerRight">            
                        ...
                        <div class="front-carousel">
                          <div id="myCarousel" class="carousel slide">
                            ...
                            <div class="item active">
                                <img src=<?php echo $rootUri."/assets/pages/img/posts/audiowhtsp.jpg"; ?> alt="">
                            </div>
                    
                            <div class="item">
                                <img src=<?php echo $rootUri."/assets/pages/img/posts/audiowtsp2.jpg"; ?> alt="">
                            </div>
                    ...
                    <h2><a href="">Tómate un tiempo para pensar antes de enviar un audio</a></h2>
                    
                    <p>WhatsApp dispone, desde hace varias semanas, de una útil función en su versión para dispositivos iOS -la plataforma de los iPhone- que permite grabar una nota de voz sin la necesidad de mantener pulsado el icono y, además, escuchar el audio antes de enviarlo. Esta característica también llegará próximamente al sistema operativo Android.</p>
                    
                    <blockquote>
                        <p>“Las notas de voz se han convertido en uno de los principales recursos para alimentar las conversaciones en WhatsApp, sobre todo entre los usuarios más jóvenes. Además de permitir que los usuarios mediten las palabras empleadas antes de compartir el audio a un determinado contacto, esta opción está concebida para evitar interrupciones durante la grabación en caso de recibir justo en ese momento una llamada entrante, por ejemplo.”.</p>
                    
                    <small>
                        <cite>
                        <a href="" ></a></cite></small></blockquote>
                        
                        <p>Pero, ¿cómo funciona? ¿Cuáles son los pasos a seguir para hacerlo? La operación es muy sencilla. Es necesario mantener pulsado el botón del micrófono -ubicado en la parte derecha al lado del campo de texto- y desplazarlo hacia arriba para que comience la grabación sin la necesidad de mantener el icono.<br />
<br />
Para poder escuchar el contenido antes es necesario volver atrás de la ventana de chat o pulsar sobre la información del perfil. Entonces, hay que regresar al campo de texto. La grabación se habrá pausado y, además de poder continuar añadiendo más contenido, se puede reproducir el audio con antelación. Esta función se activa de manera automática en caso sufrir una interrupción.</p>
                        
                                <br><br><p> <a href="http://www.abc.es/tecnologia/consultorio/abci-como-escuchar-nota-whastapp-antes-enviarla-20180425121" target="_blank">Fuente:Abc.es</a></p>
                                <div>
                        ...
                        href="https://twitter.com/intent/tweet?text=Tómate un tiempo para pensar antes de enviar un audio @softdirex">
                        Tweet</a>

                        <script src="//platform.linkedin.com/in.js" type="text/javascript"> lang: es_ES</script>
                        <script type="IN/Share" data-url="https://www.softdirex.cl/2018/04/26/escuchar-las-notas-de-voz-de-tu-whatsapp-antes-de-enviarlas.php"></script>
                        
                        <div class="fb-like" data-href="https://www.softdirex.cl/2018/04/26/escuchar-las-notas-de-voz-de-tu-whatsapp-antes-de-enviarlas.php" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
                        
                        <a href="https://api.whatsapp.com/send?text=Me%20gustaría%20compartirte%20esta%20info%20https://www.softdirex.cl/2018/04/26/escuchar-las-notas-de-voz-de-tu-whatsapp-antes-de-enviarlas.php" style="border-radius: 7px; -moz-border-radius: 7px; -webkit-border-radius: 7px; display: inline-block; text-decoration: none; text-align: center; font-size: x-small; padding: 4px; color: white; background-color: green;" target="_blank"><i class="fa fa-whatsapp"></i>Compartir</a>

                        </div>
                    <ul class="blog-info">
                    <li><i class="fa fa-user"></i> Jorge Leiva - CEO Softdirex</li>
                    <li><i class="fa fa-calendar"></i>2018-04-26</li>
                    </ul>
                    <h2>Comentarios</h2>
                  <div class="comments">
                    <?php
                  ...
                  <div class="post-comment padding-top-40">
                    ...
                    <form role="form" action="../../../int/fn/comentar.php" method="post">
                      <div class="form-group">
                        ...
                        <input type="hidden" name="link" id="link" value="https://www.softdirex.cl/2018/04/26/escuchar-las-notas-de-voz-de-tu-whatsapp-antes-de-enviarlas.php">
                      </div>
