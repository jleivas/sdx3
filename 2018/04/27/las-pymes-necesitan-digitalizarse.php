    ...
    <head>
      <meta charset="utf-8">
      <title>Las pymes necesitan digitalizarse</title>
      <script>
      ...
      <meta property="og:title" content="Las pymes necesitan digitalizarse">
      <meta property="og:description" content="Muchas empresas quieren cambiar, quieren digitalizarse, pero">
      <meta property="og:type" content="website">
      <meta property="og:image" content="https://www.softdirex.cl/assets/pages/img/posts/digital-strategy.jpg"><!-- link to image for socio -->
      <meta property="og:url" content="https://www.softdirex.cl/2018/04/27/las-pymes-necesitan-digitalizarse.php">
            ...
            <div class="col-md-12 col-sm-12">
              <!-- Inicio Contenido principal   ------------------------------------------------>
                <div id="containerRight">            
                        ...
                        <div class="front-carousel">
                          <div id="myCarousel" class="carousel slide">
                            ...
                            <div class="item active">
                                <img src=<?php echo $rootUri."/assets/pages/img/posts/digital-strategy.jpg"; ?> alt="">
                            </div>
                    ...
                    <h2><a href="">Muchas empresas quieren cambiar, quieren digitalizarse, pero</a></h2>
                    
                    <p>Las pymes poco a poco se están dando cuenta que el mundo a su alrededor está cambiando, por lo tanto necesitan ser más eficaces y productivas, necesitan modernizar urgentemente sus herramientas y entienden que deben afrontar la situación mas no saben cómo ni qué costos implica aquello.</p>
                    
                    <blockquote>
                        <p>“Hasta ahora muchas pymes han sobrevivido con soluciones a la rápida y herramientas que suplen sus necesidades de manera temporal, pero muchas veces terminan generando otras necesidades o problemas mayores.”</p>
                    
                    <small>Jorge Leiva
                        <cite>
                        <a href="" >CEO Softdirex</a></cite></small></blockquote>
                        
                        <p>Desde ahora deben comenzar a introducirse en el mundo digital apuntando a un objetivo claro para poder desenvolverse en el mundo de los negocios actual.<br />
<br />
El punto principal debe tener como objetivo mejorar tanto la forma de trabajar como su productividad, esto debe hacerse notar para que el cliente vea en la empresa un proveedor en el cual cree que obtendrá resultados esperados y acorde al sistema actual, es decir, el objetivo final siempre termina siendo el cliente.<br />
<br />
Absolutamente existen empresas que necesitan orientación en este aspecto, de esta forma irán trabajando al nivel de sus pares que ya han dado este paso tan importante, si necesitas orientación solicita información <a href="../../../page-contacts.html" target="_blank">aquí</a>.<br />
</p>
                        <div>
                        ...
                        href="https://twitter.com/intent/tweet?text=Muchas empresas quieren cambiar, quieren digitalizarse, pero @softdirex">
                        Tweet</a>

                        <script src="//platform.linkedin.com/in.js" type="text/javascript"> lang: es_ES</script>
                        <script type="IN/Share" data-url="https://www.softdirex.cl/2018/04/27/las-pymes-necesitan-digitalizarse.php"></script>
                        
                        <div class="fb-like" data-href="https://www.softdirex.cl/2018/04/27/las-pymes-necesitan-digitalizarse.php" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
                        
                        <a href="https://api.whatsapp.com/send?text=Me%20gustaría%20compartirte%20esta%20info%20https://www.softdirex.cl/2018/04/27/las-pymes-necesitan-digitalizarse.php" style="border-radius: 7px; -moz-border-radius: 7px; -webkit-border-radius: 7px; display: inline-block; text-decoration: none; text-align: center; font-size: x-small; padding: 4px; color: white; background-color: green;" target="_blank"><i class="fa fa-whatsapp"></i>Compartir</a>

                        </div>
                    <ul class="blog-info">
                    <li><i class="fa fa-user"></i> Jorge Leiva - CEO Softdirex</li>
                    <li><i class="fa fa-calendar"></i>2018-04-27</li>
                    </ul>
                    <h2>Comentarios</h2>
                  <div class="comments">
                    <?php
                  ...
                  <div class="post-comment padding-top-40">
                    ...
                    <form role="form" action="../../../int/fn/comentar.php" method="post">
                      <div class="form-group">
                        ...
                        <input type="hidden" name="link" id="link" value="https://www.softdirex.cl/2018/04/27/las-pymes-necesitan-digitalizarse.php">
                      </div>
