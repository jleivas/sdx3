    ...
    <head>
      <meta charset="utf-8">
      <title>correo corporativo gmail</title>
      <script>
      ...
      <meta property="og:title" content="correo corporativo gmail">
      <meta property="og:description" content="Utiliza gmail para tus correos corporativos">
      <meta property="og:type" content="website">
      <meta property="og:image" content="https://www.softdirex.cl/assets/pages/img/posts/gmail__product_sans_logo.png"><!-- link to image for socio -->
      <meta property="og:url" content="https://www.softdirex.cl/2018/04/27/correo-corporativo-gmail.php">
            ...
            <div class="col-md-12 col-sm-12">
              <!-- Inicio Contenido principal   ------------------------------------------------>
                <div id="containerRight">            
                        ...
                        <div class="front-carousel">
                          <div id="myCarousel" class="carousel slide">
                            ...
                            <div class="item active">
                                <img src=<?php echo $rootUri."/assets/pages/img/posts/gmail__product_sans_logo.png"; ?> alt="">
                            </div>
                    
                            <div class="item">
                                <img src=<?php echo $rootUri."/assets/pages/img/posts/New_Logo_Gmail.svg.png"; ?> alt="">
                            </div>
                    ...
                    <h2><a href="">Utiliza gmail para tus correos corporativos</a></h2>
                    
                    <p>Ayer informábamos que google actualizó su interfaz de correo electrónico Gmail, si bien es sabido que la firma está entre las plataformas más utilizadas para el uso de los correos electrónicos, y los usuarios tienen sus razones bien fundamentadas para hacerlo, es rápida, segura y muy fácil de usar, además está presente para todos los dispositivos móviles y como es bien sabido, es gratuita para uso personal.<br />
</p>
                    
                    <blockquote>
                        <p>“La gran noticia es que ahora puedes usar todas las características de Gmail pero en tu correo corporativo, a continuación te indicamos los requisitos y las características de este nuevo servicio que ofrecemos para que no tengas más dolores de cabeza con tus correos electrónicos.”.</p>
                    
                    <small>Servicios de hosting
                        <cite>
                        <a href="" >Softdirex</a></cite></small></blockquote>
                        
                        <p>Para obtener este producto debes tener un sitio web proporcionado por Softdirex y debes tener en cuenta que este servicio incluye un cobro mensual directo de parte de Google.<br />
<br />
para mas info <a href="http://www.softdirex.cl/page-contacts.html" target="_blank">contáctanos</a>.</p>
                        <div>
                        ...
                        href="https://twitter.com/intent/tweet?text=Utiliza gmail para tus correos corporativos @softdirex">
                        Tweet</a>

                        <script src="//platform.linkedin.com/in.js" type="text/javascript"> lang: es_ES</script>
                        <script type="IN/Share" data-url="https://www.softdirex.cl/2018/04/27/correo-corporativo-gmail.php"></script>
                        
                        <div class="fb-like" data-href="https://www.softdirex.cl/2018/04/27/correo-corporativo-gmail.php" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
                        
                        <a href="https://api.whatsapp.com/send?text=Me%20gustaría%20compartirte%20esta%20info%20https://www.softdirex.cl/2018/04/27/correo-corporativo-gmail.php" style="border-radius: 7px; -moz-border-radius: 7px; -webkit-border-radius: 7px; display: inline-block; text-decoration: none; text-align: center; font-size: x-small; padding: 4px; color: white; background-color: green;" target="_blank"><i class="fa fa-whatsapp"></i>Compartir</a>
                  ...
                  <div class="post-comment padding-top-40">
                    ...
                    <form role="form" action="../../../int/fn/comentar.php" method="post">
                      <div class="form-group">
                        ...
                        <input type="hidden" name="link" id="link" value="https://www.softdirex.cl/2018/04/27/correo-corporativo-gmail.php">
                      </div>
