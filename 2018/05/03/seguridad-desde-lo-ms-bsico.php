    ...
    <head>
      <meta charset="utf-8">
      <title>Seguridad desde lo más básico</title>
      <script>
      ...
      <meta property="og:title" content="Seguridad desde lo más básico">
      <meta property="og:description" content="La seguridad debe ser un hábito en las empresas">
      <meta property="og:type" content="website">
      <meta property="og:image" content="https://www.softdirex.cl/assets/pages/img/posts/03052018sec.jpg"><!-- link to image for socio -->
      <meta property="og:url" content="https://www.softdirex.cl/2018/05/03/seguridad-desde-lo-ms-bsico.php">
            ...
            <div class="col-md-12 col-sm-12">
              <!-- Inicio Contenido principal   ------------------------------------------------>
                <div id="containerRight">            
                        ...
                        <div class="front-carousel">
                          <div id="myCarousel" class="carousel slide">
                            ...
                            <div class="item active">
                                <img src=<?php echo $rootUri."/assets/pages/img/posts/03052018sec.jpg"; ?> alt="">
                            </div>
                    ...
                    <h2><a href="">La seguridad debe ser un hábito en las empresas</a></h2>
                    
                    <p>La seguridad de la información en las empresas es algo que muchas organizaciones no acaban de tomarse del todo en serio. Se trata muchas veces de potenciar la usabilidad, la comodidad, para que cualquiera pueda acceder a cualquier equipo para trabajar o hacerlo desde casa con información que nos hemos llevado para ello. Por eso es habitual poner en riesgo cada día los sistemas y datos en nuestro puesto de trabajo.</p>
                    
                    <blockquote>
                        <p>“Lo cierto es que la mayoría de las empresas piensan que por tener una empresa familiar, donde todos se conocen, no están obligadas a cumplir con unas mínimas precauciones. Y se relaja toda medida de seguridad, que se ven por otra parte como un incordio, algo que molesta, más que una medida de protección ante cualquier problema, tanto interno como externo.”.</p>
                    
                    <small>
                        <cite>
                        <a href="" ></a></cite></small></blockquote>
                        
                        <p>El ejemplo más común son los equipos sin bloquear cuando el usuario se marcha o abandona su puesto durante unos minutos. Y cualquiera puede llegar a dicho puesto y ponerse a revisar datos de clientes. Pensamos que porque la empresa sea pequeña y todo el mundo se conozca no va a pasar nada. Pero muchas veces el control se toma desde fuera, con un ataque que al no tener que poner la contraseña lo pone realmente fácil.<br />
<br />
Cualquiera puede acceder a otros ordenadores con diferentes usuarios en la mayoría de las empresas y esto puede ser un grave problema<br />
Algo similar ocurre cuando las contraseñas están anotadas en una nota adhesiva o que todo el mundo conoce. Y de esta forma se invalida cualquier trazabilidad en el acceso a los documentos que se pueda programar. Si todo el mundo conoce los datos del resto, no sirve de nada intentar investigar quién accedió a qué documento o datos de clientes que no deberían haber salido a la luz.<br />
<br />
Si hablamos de datos sin control, es habitual pasar información corporativa a un USB o disco virtual en la nube o a través mensajería instantánea. Y sin ningún tipo de cifrado. En el caso de los discos virtuales es aún más grave porque muchas veces se intercambia información con clientes o empresas, que pueden verse afectadas por un problema de seguridad que propagan a través de dicho disco a la nuestra.<br />
<br />
Más habitual todavía es ver documentación por encima de las mesas al alcance de todos. En muchos sitios no se guarda ni siquiera en las cajoneras. De esta forma basta que de forma accidental alguien deje sus cosas en una mesa para a la hora de recoger llevarse una carpeta que no corresponde con datos confidenciales de clientes que deberían estar protegidos.</p>
                                ...
                                <br><br><p> <a href="https://www.pymesyautonomos.com/consejos-practicos/asi-ponemos-en-riesgo-cada-dia-los-sistemas-y-dat" target="_blank">Fuente:Pymes y autónomos</a></p>
                                <div>
                        ...
                        href="https://twitter.com/intent/tweet?text=La seguridad debe ser un hábito en las empresas @softdirex">
                        Tweet</a>

                        <script src="//platform.linkedin.com/in.js" type="text/javascript"> lang: es_ES</script>
                        <script type="IN/Share" data-url="https://www.softdirex.cl/2018/05/03/seguridad-desde-lo-ms-bsico.php"></script>
                        
                        <div class="fb-like" data-href="https://www.softdirex.cl/2018/05/03/seguridad-desde-lo-ms-bsico.php" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
                        
                        <a href="https://api.whatsapp.com/send?text=Me%20gustaría%20compartirte%20esta%20info%20https://www.softdirex.cl/2018/05/03/seguridad-desde-lo-ms-bsico.php" style="border-radius: 7px; -moz-border-radius: 7px; -webkit-border-radius: 7px; display: inline-block; text-decoration: none; text-align: center; font-size: x-small; padding: 4px; color: white; background-color: green;" target="_blank"><i class="fa fa-whatsapp"></i>Compartir</a>

                        </div>
                    <ul class="blog-info">
                    <li><i class="fa fa-user"></i> Jorge Leiva - CEO Softdirex</li>
                    <li><i class="fa fa-calendar"></i>2018-05-03</li>
                    </ul>
                    <h2>Comentarios</h2>
                  <div class="comments">
                    <?php
                  ...
                  <div class="post-comment padding-top-40">
                    ...
                    <form role="form" action="../../../int/fn/comentar.php" method="post">
                      <div class="form-group">
                        ...
                        <input type="hidden" name="link" id="link" value="https://www.softdirex.cl/2018/05/03/seguridad-desde-lo-ms-bsico.php">
                      </div>
