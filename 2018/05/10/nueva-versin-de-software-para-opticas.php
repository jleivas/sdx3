    ...
    <head>
      <meta charset="utf-8">
      <title>Nueva versión de software para Opticas</title>
      <script>
      ...
      <meta property="og:title" content="Nueva versión de software para Opticas">
      <meta property="og:description" content="La nueva versión 4.0 de Optidata ya está en desarrollo">
      <meta property="og:type" content="website">
      <meta property="og:image" content="https://www.softdirex.cl/assets/pages/img/posts/051020184.png"><!-- link to image for socio -->
      <meta property="og:url" content="https://www.softdirex.cl/2018/05/10/nueva-versin-de-software-para-opticas.php">
            ...
            <div class="col-md-12 col-sm-12">
              <!-- Inicio Contenido principal   ------------------------------------------------>
                <div id="containerRight">            
                        ...
                        <div class="front-carousel">
                          <div id="myCarousel" class="carousel slide">
                            ...
                            <div class="item active">
                                <img src=<?php echo $rootUri."/assets/pages/img/posts/051020184.png"; ?> alt="">
                            </div>
                    
                            <div class="item">
                                <img src=<?php echo $rootUri."/assets/pages/img/posts/051020182.png"; ?> alt="">
                            </div>
                    
                            <div class="item">
                                <img src=<?php echo $rootUri."/assets/pages/img/posts/051020183.png"; ?> alt="">
                            </div>
                    ...
                    <h2><a href="">La nueva versión 4.0 de Optidata ya está en desarrollo</a></h2>
                    
                    <p>Ya se encuentra en pleno proceso de desarrollo la nueva versión de OptiData que promete mejoras considerables para su desempeño a un estándar superior.</p>
                    
                    <blockquote>
                        <p>“Aparte de traer una nueva cara, el Software va a ser capaz de manejar dos bases de datos, una local y otra remota desde donde se podrá sincronizar y respaldar los datos, permitiendo el futuro acceso tanto de aplicaciones web como móviles.”</p>
                    
                    <small>Jorge Leiva
                        <cite>
                        <a href="" >CEO Softdirex</a></cite></small></blockquote>
                        
                        <p>Se pretende mejorar la fluidez de sus datos y hacer del software una herramienta de fácil manejo para los usuarios finales. En esta nueva versión se está trabajando arduamente para disponer de ella antes del segundo semestre del presente año, para obtener más info acerca de la herramienta <a href="http://optidata.softdirex.cl" target="_blank">visite aquí</a>.</p>
                        <div>
                        ...
                        href="https://twitter.com/intent/tweet?text=La nueva versión 4.0 de Optidata ya está en desarrollo @softdirex">
                        Tweet</a>

                        <script src="//platform.linkedin.com/in.js" type="text/javascript"> lang: es_ES</script>
                        <script type="IN/Share" data-url="https://www.softdirex.cl/2018/05/10/nueva-versin-de-software-para-opticas.php"></script>
                        
                        <div class="fb-like" data-href="https://www.softdirex.cl/2018/05/10/nueva-versin-de-software-para-opticas.php" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
                        
                        <a href="https://api.whatsapp.com/send?text=Me%20gustaría%20compartirte%20esta%20info%20https://www.softdirex.cl/2018/05/10/nueva-versin-de-software-para-opticas.php" style="border-radius: 7px; -moz-border-radius: 7px; -webkit-border-radius: 7px; display: inline-block; text-decoration: none; text-align: center; font-size: x-small; padding: 4px; color: white; background-color: green;" target="_blank"><i class="fa fa-whatsapp"></i>Compartir</a>

                        </div>
                    <ul class="blog-info">
                    <li><i class="fa fa-user"></i> Jorge Leiva - CEO Softdirex</li>
                    <li><i class="fa fa-calendar"></i>2018-05-10</li>
                    </ul>
                    <h2>Comentarios</h2>
                  <div class="comments">
                    <?php
                  ...
                  <div class="post-comment padding-top-40">
                    ...
                    <form role="form" action="../../../int/fn/comentar.php" method="post">
                      <div class="form-group">
                        ...
                        <input type="hidden" name="link" id="link" value="https://www.softdirex.cl/2018/05/10/nueva-versin-de-software-para-opticas.php">
                      </div>
