    ...
    <head>
      <meta charset="utf-8">
      <title>Mejora tu sitio web para que tengas un mejor servicio</title>
      <script>
      ...
      <meta property="og:title" content="Mejora tu sitio web para que tengas un mejor servicio">
      <meta property="og:description" content="Para mejorar tu servicio, debes mejorar tu sitio web">
      <meta property="og:type" content="website">
      <meta property="og:image" content="https://www.softdirex.cl/assets/pages/img/posts/09052018.png"><!-- link to image for socio -->
      <meta property="og:url" content="https://www.softdirex.cl/2018/05/09/mejora-tu-sitio-web-para-que-tengas-un-mejor-servicio.php">
            ...
            <div class="col-md-12 col-sm-12">
              <!-- Inicio Contenido principal   ------------------------------------------------>
                <div id="containerRight">            
                        ...
                        <div class="front-carousel">
                          <div id="myCarousel" class="carousel slide">
                            ...
                            <div class="item active">
                                <img src=<?php echo $rootUri."/assets/pages/img/posts/09052018.png"; ?> alt="">
                            </div>
                    ...
                    <h2><a href="">Para mejorar tu servicio, debes mejorar tu sitio web</a></h2>
                    
                    <p>Cuando a un sitio web se le dedica poco cuidado y tiempo, su dejadez la percibe el cliente. Debes tener en cuenta que es un vehículo para transportar tus servicios a los usuarios.</p>
                    
                    <blockquote>
                        <p>“No se trata de ser una empresa menos moderna o más moderna, ni de tener un sitio web muy llamativo, lo esencial es que el sitio web sea funcional y entregue los resultados esperados a tus clientes.”</p>
                    
                    <small>Jorge Leiva
                        <cite>
                        <a href="" >CEO Softdirex</a></cite></small></blockquote>
                        
                        <p>Es importante que tengas a tu disposición a un profesional en la materia que tome tu necesidad como un problema a resolver, no como un problema a sustituir.<br />
<br />
Un verdadero sitio web es más que un escaparate, tiene que estar en constante mejora. Tus clientes te lo agradecerán.</p>
                        <div>
                        ...
                        href="https://twitter.com/intent/tweet?text=Para mejorar tu servicio, debes mejorar tu sitio web @softdirex">
                        Tweet</a>

                        <script src="//platform.linkedin.com/in.js" type="text/javascript"> lang: es_ES</script>
                        <script type="IN/Share" data-url="https://www.softdirex.cl/2018/05/09/mejora-tu-sitio-web-para-que-tengas-un-mejor-servicio.php"></script>
                        
                        <div class="fb-like" data-href="https://www.softdirex.cl/2018/05/09/mejora-tu-sitio-web-para-que-tengas-un-mejor-servicio.php" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
                        
                        <a href="https://api.whatsapp.com/send?text=Me%20gustaría%20compartirte%20esta%20info%20https://www.softdirex.cl/2018/05/09/mejora-tu-sitio-web-para-que-tengas-un-mejor-servicio.php" style="border-radius: 7px; -moz-border-radius: 7px; -webkit-border-radius: 7px; display: inline-block; text-decoration: none; text-align: center; font-size: x-small; padding: 4px; color: white; background-color: green;" target="_blank"><i class="fa fa-whatsapp"></i>Compartir</a>

                        </div>
                    <ul class="blog-info">
                    <li><i class="fa fa-user"></i> Jorge Leiva - CEO Softdirex</li>
                    <li><i class="fa fa-calendar"></i>2018-05-09</li>
                    </ul>
                    <h2>Comentarios</h2>
                  <div class="comments">
                    <?php
                  ...
                  <div class="post-comment padding-top-40">
                    ...
                    <form role="form" action="../../../int/fn/comentar.php" method="post">
                      <div class="form-group">
                        ...
                        <input type="hidden" name="link" id="link" value="https://www.softdirex.cl/2018/05/09/mejora-tu-sitio-web-para-que-tengas-un-mejor-servicio.php">
                      </div>
