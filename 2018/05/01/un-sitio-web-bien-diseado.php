    ...
    <head>
      <meta charset="utf-8">
      <title>Un sitio web bien diseñado</title>
      <script>
      ...
      <meta property="og:title" content="Un sitio web bien diseñado">
      <meta property="og:description" content="Un buen cambio depende de un buen diseño">
      <meta property="og:type" content="website">
      <meta property="og:image" content="https://www.softdirex.cl/assets/pages/img/posts/03052018.jpg"><!-- link to image for socio -->
      <meta property="og:url" content="https://www.softdirex.cl/2018/05/01/un-sitio-web-bien-diseado.php">
            ...
            <div class="col-md-12 col-sm-12">
              <!-- Inicio Contenido principal   ------------------------------------------------>
                <div id="containerRight">            
                        ...
                        <div class="front-carousel">
                          <div id="myCarousel" class="carousel slide">
                            ...
                            <div class="item active">
                                <img src=<?php echo $rootUri."/assets/pages/img/posts/03052018.jpg"; ?> alt="">
                            </div>
                    ...
                    <h2><a href="">Un buen cambio depende de un buen diseño</a></h2>
                    
                    <p>El peso de internet, de la imagen y de lo audiovisual han revolucionado la forma en la que las empresas se acercan a sus clientes, lo que ha llevado a que la transformación digital se haya convertido en una prioridad para la mayoría de ellas. Dentro de este profundo desafío, el perfil de los diseñadores gráficos juega un rol esencial, y es hoy una profesión muy demandada en todos los sectores que quieren liderar con éxito esa convergencia tecnológica. \“El mundo del diseño ha sido el primero en sentir la revolución digital y, en la actualidad, las funciones del diseñador han conquistado otros ámbitos en los que su papel es más necesario que nunca\”, señala Vanessa Ruiz, coordinadora del grado en Diseño Digital en el Centro Universitario U-tad.</p>
                    
                    <blockquote>
                        <p>“La evolución hacia lo digital ha hecho que todo lo visual tenga mucho más impacto que antes: hoy se llega principalmente a los clientes a través de páginas webs atractivas y de aplicaciones intuitivas y cómodas de usar. Y que la experiencia a través de estas plataformas sea satisfactoria depende esencialmente del trabajo de los diseñadores.”.</p>
                    
                    <small>
                        <cite>
                        <a href="" ></a></cite></small></blockquote>
                        
                        <p>Según un estudio elaborado por la Sociedad Estatal para el Desarrollo del Diseño y la Innovación en Europa (España), el 72% de los encuestados cree que el crecimiento en las ventas de las empresas se debe a la incidencia del diseño. Una de las compañías que más claramente ha apostado por ese cambio es el Banco BBVA, que lidera en la actualidad la transformación digital, no solo dentro del sector bancario, sino también en muchos otros ámbitos.<br />
<br />
</p>
                        
                                <br><br><p> <a href="https://cincodias.elpais.com/cincodias/2018/04/27/fortunas/1524854807_750691.html?utm_source=dlvr.it" target="_blank">Fuente:El pais</a></p>
                                <div>
                        ...
                        href="https://twitter.com/intent/tweet?text=Un buen cambio depende de un buen diseño @softdirex">
                        Tweet</a>

                        <script src="//platform.linkedin.com/in.js" type="text/javascript"> lang: es_ES</script>
                        <script type="IN/Share" data-url="https://www.softdirex.cl/2018/05/01/un-sitio-web-bien-diseado.php"></script>
                        
                        <div class="fb-like" data-href="https://www.softdirex.cl/2018/05/01/un-sitio-web-bien-diseado.php" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
                        
                        <a href="https://api.whatsapp.com/send?text=Me%20gustaría%20compartirte%20esta%20info%20https://www.softdirex.cl/2018/05/01/un-sitio-web-bien-diseado.php" style="border-radius: 7px; -moz-border-radius: 7px; -webkit-border-radius: 7px; display: inline-block; text-decoration: none; text-align: center; font-size: x-small; padding: 4px; color: white; background-color: green;" target="_blank"><i class="fa fa-whatsapp"></i>Compartir</a>

                        </div>
                    <ul class="blog-info">
                    <li><i class="fa fa-user"></i> Jorge Leiva - CEO Softdirex</li>
                    <li><i class="fa fa-calendar"></i>2018-05-01</li>
                    </ul>
                    <h2>Comentarios</h2>
                  <div class="comments">
                    <?php
                  ...
                  <div class="post-comment padding-top-40">
                    ...
                    <form role="form" action="../../../int/fn/comentar.php" method="post">
                      <div class="form-group">
                        ...
                        <input type="hidden" name="link" id="link" value="https://www.softdirex.cl/2018/05/01/un-sitio-web-bien-diseado.php">
                      </div>
