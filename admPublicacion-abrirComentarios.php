    ...
    <div class="main">
      <div class="container">
        <ul class="breadcrumb">
            ...
            <li class="active">Comentarios de: <?php echo $blog->getTitulo(); ?></li>
        </ul>
        <!-- BEGIN SIDEBAR & CONTENT -->
        <div class="row margin-bottom-40">
          <!-- BEGIN CONTENT -->
          <div class="col-md-12 col-sm-12">
            <h1>Comentarios de <?php echo $blog->getTitulo(); ?></h1>
                ...
                <div class="col-md-11 col-sm-11 blog-posts">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-11 col-sm-11">
                      <h2><a href=""><?php echo $fila['com_id']; ?></a></h2>
                      <ul class="blog-info">
                        <li><i class="fa fa-calendar"></i><?php echo $fila['com_fecha']; ?></li>
                        <li><i class="fa fa-user-circle"></i>Autor: <?php echo $fila['com_autor']; ?></li>
                      </ul>
                      <p><?php echo $fila['com_mensaje']; ?></p>
                      <form action="int/fn/anularComentario.php" method="post">
                        <input type="hidden" name="id" value="<?php echo $fila['com_id'] ?>">
                        <input type="submit" class="btn btn-danger" name="" value="Anular">
                      </form>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-11 col-sm-11">
                      <h2><a href="">No existen comentarios</a></h2>
                      <ul class="blog-info">
                      </ul>
                    </div>
                  </div>
