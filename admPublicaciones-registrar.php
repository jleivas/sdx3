...
<head>
  <meta charset="utf-8">
  <title>Registrar publicacion - Softdirex</title>
  <script>
          ...
          <ul>
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a href="admPublicaciones-registrar.php">Registrar</a></li>
    ...
    <div class="main">
      <div class="container">
        <ul class="breadcrumb">
            ...
            <li class="active">Registrar publicación</li>
        </ul>
                ...
                <div class="col-md-7 col-sm-7">
                  <form action="int/fn/parseHtml.php" class="form-horizontal" role="form" method="post">
                    <fieldset>
                      ...
                      <div class="form-group">
                        <label for="autor" class="col-lg-4 control-label">Autor <span class="require">*</span></label>
                        <div class="col-lg-8">
                          <input type="text" class="form-control" id="autor" name="autor" value="<?php echo $_SESSION['usuario']->getNombre(); ?>" minlength="4" maxlength="25" required="">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="fecha" class="col-lg-4 control-label">Fecha<span class="require">*</span></label>
                        <div class="col-lg-8">
                          <input type="date" class="form-control" id="fecha" name="fecha" minlength="8" maxlength="12" required="">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-lg-8">
                          <select name="categoria" class="form-control">
                            ...
                            <option value="3">Tecnolgía</option>
                    ...
                    <fieldset>
                      <legend>Enviar boletín </legend>
                        <label>
                          <div class="col-lg-12">
                            <select name="enviar" class="form-control">
                            <option value="1">No enviar</option>
                            <option value="2">Enviar notificación de nuevo contenido</option>
                          </select>
                          </div>
                        </label>
                    </fieldset>
