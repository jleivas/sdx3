...
<head>
  <meta charset="utf-8">
  <title>Comentarios - Softdirex</title>
  <script>
  ...
  */
  ...
  (min-device-width: 768px) and (max-device-width: 1024px)  {
    ...
    */
    ...
    td:nth-of-type(5):before { content: "Comentarios"; }
          ...
          <ul>
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a href="admPublicaciones-comentarios.php">Comentarios</a></li>
          ...
          <div class="col-md-12 col-sm-12">
              <table>
                ...
                <tr>
                  ...
                  <td><?php echo $fila['blo_titulo']; ?></td>
                  <td><?php echo $fila['blo_autor']; ?></td>
                  <td><?php echo $fila['blo_fecha']; ?></td>
                  <td>
                      <?php
                  ...
                  <td><?php echo ComentarioDao::sqlContar($fila['blo_link']) ?></td>
                  </form>
                  <td>
                    <?php
                    if($estado!=0){
                    ?>
                    <a href="admPublicacion-abrirComentarios.php?link=<?php echo $fila['blo_link']; ?>&estado=1" class="btn-success">Gestionar</a>
                    <?php
                    }else{
                    ?>
