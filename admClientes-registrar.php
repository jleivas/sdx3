          ...
          <ul>
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a href="admClientes-registrar.php">Registrar</a></li>
        ...
        <div class="row margin-bottom-40">
          ...
          <div class="sidebar col-md-3 col-sm-3">
            <ul class="list-group margin-bottom-25 sidebar-menu">
              <li class="list-group-item clearfix"><a href="admClientes-mostrar.php"><i class="fa fa-angle-right"></i> Actualizar usuarios</a></li>
              <li class="list-group-item clearfix"><a href="admClientes-morosos.php"><i class="fa fa-angle-right"></i> Revisa morosos</a></li>
            </ul>
          </div>
          <!-- END SIDEBAR -->
            ...
            <div class="content-form-page">
              <div class="row">
                <div class="col-md-7 col-sm-7">
                  <form action="int/fn/admCliente-registrar.php" class="form-horizontal" role="form" method="post"><!-- registroMail.php -->
                    <fieldset>
                      <legend>Datos personales</legend>
                      <div class="form-group">
                        <label for="rut" class="col-lg-4 control-label">Rut <span class="require">*</span></label>
                        <div class="col-lg-8">
                          <input type="text" class="form-control" id="rut" name="rut"  minlength="10" maxlength="10" placeholder="Sin puntos (Ejemplo: 12345678-0)" required="">
                        </div>
                      </div>
                      <div class="form-group">
                    ...
                    <fieldset>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-8">
                          <input type="password" class="form-control" id="pass" name="pass" minlength="4" maxlength="25" required="" placeholder="La contraseña será encriptada">
                        </div>
                      </div>
                    </fieldset>
                    <fieldset>
                      ...
                      <div class="form-group">
                        <label for="pass1" class="col-lg-4 control-label">Tipo <span class="require">*</span></label>
                        <div class="col-lg-8">
                    ...
                    <div class="row">
                      <div class="col-lg-8 col-md-offset-4 padding-left-0 padding-top-20">                        
                        <button type="submit" class="btn btn-primary">Crear cuenta</button>&nbsp;&nbsp;&nbsp;<a href="javascript:history.back(-1)" class="btn btn-default">Cancelar</a>
                      </div>
                    </div>
                  </form>
                </div>
