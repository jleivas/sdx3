        ...
        <div class="row margin-bottom-40">
          ...
          <div class="col-md-12 col-sm-12">
            ...
            <div class="content-page">
                <div class="filter-v1">
                  <ul class="mix-filter">
                    <a href="portafolio.php"><li data-filter="all" class="filter active">Todos</li></a>
                    <a href="portafolio-1.php"><li data-filter="category_1" class="filter">Sitios web</li></a>
                    <a href="portafolio-2.php"><li data-filter="category_2" class="filter">Aplicaciones web</li></a>
                    <a href="portafolio-3.php"><li data-filter="category_3" class="filter">Aplicaciones de escritorio</li></a>
