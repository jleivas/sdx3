...
$misRegistros = BlogDao::sqlEstado(1);
    ...
    <div class="main">
      <div class="container">
        <ul class="breadcrumb">
            ...
            <li class="active">Enviar boletín</li>
        </ul>
          ...
          <div class="col-md-12 col-sm-12">
              <table>
                ...
                <tr>
                  ...
                  <td>
                    <a href="admPublicacion-enviarBoletin.php?link=<?php echo $fila['blo_link']; ?>" class="btn-success">Enviar</a>
                  </td>
                </tr>
                <?php
                }
